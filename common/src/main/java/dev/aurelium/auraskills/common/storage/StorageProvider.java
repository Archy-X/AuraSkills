...
public abstract class StorageProvider {
    ...
    public void load(UUID uuid, @Nullable Object platformPlayer) throws Exception {
    ...
    protected abstract User loadRaw(UUID uuid, Object platformPlayer) throws Exception;
