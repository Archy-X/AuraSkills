...
public record LootSourceItem(String[] materials, String[] excludedMaterials, ItemCategory category, ItemFilterMeta meta, String lootTable) implements LootItemFilter {
