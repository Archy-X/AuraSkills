...
public record LootSourceItem(String[] materials, String[] excludedMaterials, ItemCategory category, ItemFilterMeta meta,
        String lootPool) implements LootItemFilter {
