...
public class LootPool extends LootOptioned {
    ...
    public LootPool(NamespacedId id, String name, List<Loot> loot, double baseChance, int selectionPriority, boolean overrideVanillaLoot, Map<String, Object> options, LootRequirements requirements) {
