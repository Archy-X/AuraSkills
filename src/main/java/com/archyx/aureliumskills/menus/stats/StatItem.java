...
public class StatItem extends AbstractItem implements TemplateItemProvider<Stat> {
    ...
    @Override
    public @NotNull Set<Stat> getDefinedContexts(Player player, ActiveMenu activeMenu) {
        return new HashSet<>(plugin.getStatRegistry().getStats());
    }

    @Override
    public String onPlaceholderReplace(@NotNull String placeholder, @NotNull Player player, ActiveMenu activeMenu, PlaceholderType type, @NotNull Stat stat) {
    ...
    private @Nullable String getSkillsLeveledBy(Stat stat, Locale locale) {
    ...
    private @Nullable String getStrengthDescriptors(@NotNull PlayerData playerData, Locale locale) {
    ...
    private @Nullable String getHealthDescriptors(@NotNull PlayerData playerData, Locale locale) {
    ...
    private @NotNull String getRegenerationDescriptors(@NotNull PlayerData playerData, Locale locale) {
    ...
    private @NotNull String getLuckDescriptors(@NotNull PlayerData playerData, Locale locale) {
    ...
    private @NotNull String getWisdomDescriptors(@NotNull PlayerData playerData, Locale locale) {
    ...
    private @Nullable String getToughnessDescriptors(@NotNull PlayerData playerData, Locale locale) {
