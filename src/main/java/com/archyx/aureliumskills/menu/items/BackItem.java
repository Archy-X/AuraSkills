...
public class BackItem implements ConfigurableItem {

    private final ItemType TYPE = ItemType.BACK;
    ...
    private final String[] definedPlaceholders = new String[] {"back_click"};
    ...
    public ItemStack getItem(Locale locale) {
        ...
        if (meta != null) {
            meta.setDisplayName(LoreUtil.replace(displayName,"{back}", Lang.getMessage(MenuMessage.BACK, locale)));
