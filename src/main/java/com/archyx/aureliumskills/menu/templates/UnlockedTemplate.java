...
public class UnlockedTemplate implements ConfigurableTemplate {
    ...
    public ItemStack getItem(Skill skill, int level, Locale locale) {
        ...
        if (meta != null) {
            meta.setDisplayName(displayName.replace("{level_unlocked}", Lang.getMessage(MenuMessage.LEVEL_UNLOCKED, locale).replace("{level}", RomanNumber.toRoman(level))));
                ...
                for (String placeholder : placeholders) {
                    switch (placeholder) {
                        ...
                        case "mana_ability":
                            ...
                            break;
                        case "unlocked":
                            line = line.replace("{unlocked}", Lang.getMessage(MenuMessage.UNLOCKED, locale));
                            break;
                    }
                }
                builtLore.add(line);
