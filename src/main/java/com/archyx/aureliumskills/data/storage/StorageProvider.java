...
public abstract class StorageProvider {
    ...
    public @NotNull PlayerData createNewPlayer(Player player) {
    ...
    protected @NotNull Map<Skill, Integer> getLevelsFromBackup(@NotNull ConfigurationSection playerDataSection, String stringId) {
    ...
    protected @NotNull Map<Skill, Double> getXpLevelsFromBackup(@NotNull ConfigurationSection playerDataSection, String stringId) {
