	...
	public void onEntityDeath(EntityDeathEvent event) {
		...
		if (e.getKiller() != null) {
			if (e.getLastDamageCause() instanceof EntityDamageByEntityEvent) {
				...
				if (ee.getDamager() instanceof Arrow == false) {
					...
					if (type.equals(EntityType.CHICKEN) || type.equals(EntityType.BAT) || type.equals(EntityType.OCELOT) || type.equals(EntityType.RABBIT)) {
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 1.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 1.0);
						}
					}
						...
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 2.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 2.0);
						}
					}
						...
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 5.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 5.0);
						}
					}
						...
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 7.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 7.0);
						}
					}
						...
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 10.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 10.0);
						}
					}
						...
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 17.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 17.0);
						}
					}
						...
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 35.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 35.0);
						}
					}
					else if (type.equals(EntityType.ELDER_GUARDIAN) || type.equals(EntityType.EVOKER)) {
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 100.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 100.0);
						}
					}
					else if (type.equals(EntityType.WITHER) || type.equals(EntityType.ENDER_DRAGON)) {
						if (SkillLoader.playerSkills.containsKey(player.getUniqueId())) {
							SkillLoader.playerSkills.get(player.getUniqueId()).addXp(Skill.FIGHTING, 7000.0);
							Leveler.playSound(player);
							Leveler.checkLevelUp(player, Skill.FIGHTING);
							Leveler.sendActionBarMessage(player, Skill.FIGHTING, 7000.0);
						}
					}
				}
			}
